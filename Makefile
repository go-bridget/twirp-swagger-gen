...
test:
	./build/twirp-swagger-gen -in example/example.proto -out example/simple/example.swagger.json -host test.example.com -I include
	./build/twirp-swagger-gen -in example/google_timestamp.proto -out example/simple/google_timestamp.swagger.json -host test.example.com -I include
